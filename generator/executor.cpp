...
int main() {
  ...
  std::unique_ptr<Module> module =
      std::make_unique<Module>("generated", context);
  IRBuilder<> builder(context);
  Type* voidType = Type::getVoidTy(context);

  Type* intType = Type::getInt32Ty(context);
  std::initializer_list<Type*> li =
      std::initializer_list<Type*>{intType, intType};
  ArrayRef<Type*> simPutPixelArgs = li;
  FunctionType* simPutPixelType =
      FunctionType::get(voidType, simPutPixelArgs, false);
  ...
  FunctionType* fill_backgroundFuncType =
      FunctionType::get(voidType, fill_backgroundArgs, false);
  Function::LinkageTypes fill_backgroundLinkage = Function::InternalLinkage;
  Function* fill_backgroundFunc =
      Function::Create(fill_backgroundFuncType, fill_backgroundLinkage,
                       fill_backgroundFuncName, module.get());

  std::string adjust_directionsFuncName = "adjust_directions";
  ArrayRef<Type*> adjust_directionsArgs = {
      ...
      Type::getInt32Ty(context),
      Type::getInt32Ty(context)};
  FunctionType* adjust_directionsFuncType =
      FunctionType::get(voidType, adjust_directionsArgs, false);
  Function::LinkageTypes adjust_directionsLinkage = Function::InternalLinkage;
  Function* adjust_directionsFunc =
      Function::Create(adjust_directionsFuncType, adjust_directionsLinkage,
                       adjust_directionsFuncName, module.get());

  std::string adjust_positionsFuncName = "adjust_positions";
  ArrayRef<Type*> adjust_positionsArgs = {
      Type::getInt64Ty(context)->getPointerTo(),
      Type::getInt64Ty(context)->getPointerTo(),
      Type::getInt64Ty(context)->getPointerTo(),
      Type::getInt64Ty(context)->getPointerTo(),
      Type::getInt32Ty(context),
      Type::getInt32Ty(context)};
  FunctionType* adjust_positionsFuncType =
      FunctionType::get(voidType, adjust_positionsArgs, false);
  Function::LinkageTypes adjust_positionsLinkage = Function::InternalLinkage;
  Function* adjust_positionsFunc =
      Function::Create(adjust_positionsFuncType, adjust_positionsLinkage,
                       adjust_positionsFuncName, module.get());

  std::string change_colorsFuncName = "change_colors";
  ArrayRef<Type*> change_colorsArgs = {
      Type::getInt64Ty(context)->getPointerTo(),
      Type::getInt64Ty(context)->getPointerTo(),
      Type::getInt64Ty(context)->getPointerTo()};
  FunctionType* change_colorsFuncType =
      FunctionType::get(voidType, change_colorsArgs, false);
  Function::LinkageTypes change_colorsLinkage = Function::InternalLinkage;
  Function* change_colorsFunc =
      Function::Create(change_colorsFuncType, change_colorsLinkage,
                       change_colorsFuncName, module.get());

  std::string reflect_dotsFuncName = "reflect_dots";
  ArrayRef<Type*> reflect_dotsArgs = {
      Type::getInt32Ty(context), Type::getInt32Ty(context),
      Type::getInt32Ty(context), Type::getInt32Ty(context),
      Type::getInt32Ty(context)};
  FunctionType* reflect_dotsFuncType =
      FunctionType::get(voidType, reflect_dotsArgs, false);
  Function::LinkageTypes reflect_dotsLinkage = Function::InternalLinkage;
  Function* reflect_dotsFunc =
      Function::Create(reflect_dotsFuncType, reflect_dotsLinkage,
                       reflect_dotsFuncName, module.get());

  std::string draw_half_circleFuncName = "draw_half_circle";
  ArrayRef<Type*> draw_half_circleArgs = {
      Type::getInt32Ty(context), Type::getInt32Ty(context),
      Type::getInt32Ty(context), Type::getInt32Ty(context),
      Type::getInt32Ty(context)};
  FunctionType* draw_half_circleFuncType =
      FunctionType::get(voidType, draw_half_circleArgs, false);
  Function::LinkageTypes draw_half_circleLinkage = Function::InternalLinkage;
  Function* draw_half_circleFunc =
      Function::Create(draw_half_circleFuncType, draw_half_circleLinkage,
                       draw_half_circleFuncName, module.get());

  std::string draw_circleFuncName = "draw_circle";
  ArrayRef<Type*> draw_circleArgs = {
      Type::getInt32Ty(context), Type::getInt32Ty(context),
      Type::getInt32Ty(context), Type::getInt32Ty(context)};
  FunctionType* draw_circleFuncType =
      FunctionType::get(voidType, draw_circleArgs, false);
  Function::LinkageTypes draw_circleLinkage = Function::InternalLinkage;
  Function* draw_circleFunc =
      Function::Create(draw_circleFuncType, draw_circleLinkage,
                       draw_circleFuncName, module.get());
  ...
  Function* appFunc =
      Function::Create(appFuncType, appLinkage, appFuncName, module.get());
  ...
  // defining fill_background function
  {
    ...
    Value* val7 = builder.CreateICmp(CmpInst::Predicate::ICMP_EQ, val6,
    ...
    Value* val11 = builder.CreateICmp(CmpInst::Predicate::ICMP_EQ, val10,
  ...
  // defining adjust_directions function
  {
    ...
    Value* val10 = builder.CreateICmp(CmpInst::Predicate::ICMP_SGT, val9,
                                      builder.getInt32(511));
    ...
    Value* val15 =
        builder.CreateSub(builder.getInt32(0), val14, "", false, true);
    ...
    Value* val19 = builder.CreateICmp(CmpInst::Predicate::ICMP_SGT, val18,
                                      builder.getInt32(255));
    ...
    Value* val23 =
        builder.CreateSub(builder.getInt32(0), val22, "", false, true);
  ...
  // defining adjust_positions function
  {
    ...
    Value* val12 = builder.CreateICmp(CmpInst::Predicate::ICMP_SGT, val11,
                                      builder.getInt32(511));
    ...
    Value* val17 =
        builder.CreateSub(builder.getInt32(0), val16, "", false, true);
    ...
    Value* val21 = builder.CreateICmp(CmpInst::Predicate::ICMP_SGT, val20,
                                      builder.getInt32(255));
    ...
    Value* val25 =
        builder.CreateSub(builder.getInt32(0), val24, "", false, true);
  ...
  // defining reflect_dots function
  {
    ...
    {
      CallInst* call =
          builder.CreateCall(simPutPixelFunc, {val11, val10, val4});
      call->setTailCall(true);
    }
    builder.CreateRetVoid();
  }
  ...
  // defining draw_half_circle function
  {
    ...
    Value* val10 = builder.CreateICmp(CmpInst::Predicate::ICMP_SLT, val2,
                                      builder.getInt32(0));
    ...
    Value* val13 =
        builder.CreateSub(builder.getInt32(3), val12, "", false, true);
    ...
    Value* val18 = builder.CreateICmp(CmpInst::Predicate::ICMP_SGT, val15,
                                      builder.getInt32(0));
    builder.CreateCondBr(val18, bb19, bb25);
    builder.SetInsertPoint(bb19);
    Value* val20 =
        builder.CreateAdd(val16, builder.getInt32(-1), "", false, true);
    Value* val21 = builder.CreateSub(val17, val20, "", false, true);
    Value* val22 =
        builder.CreateShl(val21, builder.getInt32(2), "", false, true);
    Value* val23 =
        builder.CreateAdd(val15, builder.getInt32(10), "", true, false);
    Value* val24 = builder.CreateAdd(val23, val22, "");
    builder.CreateBr(bb29);
    builder.SetInsertPoint(bb25);
    Value* val26 =
        builder.CreateShl(val17, builder.getInt32(2), "", false, true);
    Value* val27 =
        builder.CreateAdd(val26, builder.getInt32(6), "", true, false);
    ...
    Value* val32 =
        builder.CreateAdd(val17, builder.getInt32(1), "", true, true);
    ...
    {
      CallInst* call =
          builder.CreateCall(simPutPixelFunc, {val35, val36, val4});
      call->setTailCall(true);
    }
    Value* val37 = builder.CreateSub(val0, val33, "", false, true);
    {
      CallInst* call =
          builder.CreateCall(simPutPixelFunc, {val37, val36, val4});
      call->setTailCall(true);
    }
    ...
    {
      CallInst* call =
          builder.CreateCall(simPutPixelFunc, {val38, val39, val4});
      call->setTailCall(true);
    }
    Value* val40 = builder.CreateSub(val0, val34, "", false, true);
    {
      CallInst* call =
          builder.CreateCall(simPutPixelFunc, {val40, val39, val4});
      call->setTailCall(true);
    }
    Value* val41 =
        builder.CreateICmp(CmpInst::Predicate::ICMP_SGT, val30, val17);
  ...
  // defining draw_circle function
  {
    ...
    builder.SetInsertPoint(bb4);
    {
      CallInst* call = builder.CreateCall(
          draw_half_circleFunc, {val0, val1, val2, builder.getInt32(1), val3});
      call->setTailCall(true);
    }
    {
      CallInst* call = builder.CreateCall(
  ...
  // defining app function
  {
    ...
    Value* val7 = builder.CreateICmp(CmpInst::Predicate::ICMP_EQ, val6,
                                     builder.getInt32(0));
    Value* val8 =
        builder.CreateSelect(val7, builder.getInt32(-1), builder.getInt32(1));
    CallInst* val9 = builder.CreateCall(simRandFunc, {});
    val9->setTailCall(true);
    ...
    Value* val11 = builder.CreateICmp(CmpInst::Predicate::ICMP_EQ, val10,
                                      builder.getInt32(0));
    Value* val12 =
        builder.CreateSelect(val11, builder.getInt32(-1), builder.getInt32(1));
    ...
    builder.SetInsertPoint(bb24);
    Value* val25 =
        builder.CreateAdd(val23, builder.getInt32(1), "", true, true);
    Value* val26 = builder.CreateICmp(CmpInst::Predicate::ICMP_EQ, val25,
                                      builder.getInt32(512));
    ...
    {
      CallInst* call =
          builder.CreateCall(simPutPixelFunc, {val23, val28, val20});
      call->setTailCall(true);
    }
    Value* val29 =
        builder.CreateAdd(val28, builder.getInt32(1), "", true, true);
    Value* val30 = builder.CreateICmp(CmpInst::Predicate::ICMP_EQ, val29,
                                      builder.getInt32(256));
    builder.CreateCondBr(val30, bb24, bb27);
    builder.SetInsertPoint(bb31);
    Value* val32 =
        builder.CreateAdd(val15, builder.getInt32(30), "", false, true);
    Value* val33 =
        builder.CreateAdd(val16, builder.getInt32(30), "", false, true);
    {
      CallInst* call = builder.CreateCall(
          draw_half_circleFunc,
          {val32, val33, builder.getInt32(30), builder.getInt32(1), val19});
      call->setTailCall(true);
    }
    {
      CallInst* call = builder.CreateCall(
    ...
    Value* val34 =
        builder.CreateAdd(val15, builder.getInt32(20), "", false, true);
    Value* val35 =
        builder.CreateAdd(val16, builder.getInt32(20), "", false, true);
    {
      CallInst* call = builder.CreateCall(
          draw_half_circleFunc,
          {val34, val35, builder.getInt32(6), builder.getInt32(1), val19});
      call->setTailCall(true);
    }
    {
      CallInst* call = builder.CreateCall(
    ...
    Value* val36 =
        builder.CreateAdd(val15, builder.getInt32(40), "", false, true);
    {
      CallInst* call = builder.CreateCall(
          draw_half_circleFunc,
          {val36, val35, builder.getInt32(6), builder.getInt32(1), val19});
      call->setTailCall(true);
    }
    {
      CallInst* call = builder.CreateCall(
    ...
    Value* val37 =
        builder.CreateAdd(val16, builder.getInt32(33), "", false, true);
    {
      CallInst* call = builder.CreateCall(
          draw_half_circleFunc,
          {val32, val37, builder.getInt32(15), builder.getInt32(1), val19});
      call->setTailCall(true);
    }
    Value* val38 = builder.CreateAdd(val15, builder.getInt32(63), "");
    Value* val39 = builder.CreateICmp(CmpInst::Predicate::ICMP_SGT, val38,
                                      builder.getInt32(511));
    Value* val40 = builder.CreateICmp(CmpInst::Predicate::ICMP_SLT, val15,
                                      builder.getInt32(3));
    Value* val41 = builder.CreateOr(val40, val39, "");
    Value* val42 =
        builder.CreateSub(builder.getInt32(0), val17, "", false, true);
    Value* val43 = builder.CreateSelect(val41, val42, val17);
    Value* val44 = builder.CreateICmp(CmpInst::Predicate::ICMP_SLT, val16,
                                      builder.getInt32(3));
    Value* val45 = builder.CreateAdd(val16, builder.getInt32(63), "");
    Value* val46 = builder.CreateICmp(CmpInst::Predicate::ICMP_SGT, val45,
                                      builder.getInt32(255));
    Value* val47 = builder.CreateOr(val44, val46, "");
    Value* val48 =
        builder.CreateSub(builder.getInt32(0), val18, "", false, true);
    Value* val49 = builder.CreateSelect(val47, val48, val18);
    Value* val50 =
        builder.CreateMul(val43, builder.getInt32(3), "", false, true);
    Value* val51 = builder.CreateAdd(val50, val15, "", false, true);
    Value* val52 =
        builder.CreateMul(val49, builder.getInt32(3), "", false, true);
    ...
    Value* val55 =
        builder.CreateSub(builder.getInt32(0), val21, "", false, true);
